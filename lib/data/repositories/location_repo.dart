...
class LocationRepo{
  ...
  Future<List<CityLocation>> getlocations({required String name,required int count})async{
    final locations =await locationWebServices.getcitylocation(name: name, count: count);
    return locations;
  }
}